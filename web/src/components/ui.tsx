...
export function Button({
  ...
  const styles = {
    ...
    // Píldora del CTA principal ("Publicar oferta de trabajo"), en amarillo.
    accent:
      'rounded-full bg-yellow-400 text-neutral-900 font-bold hover:bg-yellow-300 hover:shadow-lg',
  }[variant];
  return (
    <button
